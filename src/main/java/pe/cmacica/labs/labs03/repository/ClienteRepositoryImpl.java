...
import pe.cmacica.labs.labs03.controller.ClienteController;
...
public class ClienteRepositoryImpl implements ClienteRepository
{
    ...
    {
        return jdbcTemplate.update("update cliente set nombres=? where id =?",new Object[]{cliente.getNombres(),cliente.getId()});
    }
